...
<section>
  <div class="wrap legal">
    ...
    <p>${site.legal.responsibleName}<br>
    ${site.legal.street}<br>
    ${site.legal.postalCode} ${site.legal.city}<br>
    E-Mail: <a href="mailto:${site.contact.email}">${site.contact.email}</a><br>
    Telefon: <a href="tel:${site.contact.phoneHref}">${site.contact.phoneDisplay}</a></p>
    ...
    <h2>Deine Rechte</h2>
    <p>Du hast jederzeit das Recht auf Auskunft (Art. 15 DSGVO), Berichtigung (Art. 16 DSGVO), Löschung (Art. 17 DSGVO), Einschränkung der Verarbeitung (Art. 18 DSGVO), Datenübertragbarkeit (Art. 20 DSGVO) sowie Widerspruch gegen die Verarbeitung (Art. 21 DSGVO) bezüglich deiner personenbezogenen Daten. Wende dich dazu an <a href="mailto:${site.contact.email}">${site.contact.email}</a>.</p>
    ...
    <a href="https://www.baden-wuerttemberg.datenschutz.de/" target="_blank" rel="noopener">www.baden-wuerttemberg.datenschutz.de</a></p>
