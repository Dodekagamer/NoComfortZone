...
<section>
  <div class="wrap legal">
    ...
    ${site.formEndpoint ? `
    <p>Wenn du eines der Anfrage-/Buchungsformulare dieser Website (z. B. Probetraining, Mitgliedschaft, Haki Sports, Unternehmens-/Schulanfragen) absendest, werden die von dir eingegebenen Daten — Name, E-Mail-Adresse sowie optional Telefonnummer, Wunschtermin und Nachricht — an uns übermittelt und per E-Mail an die zuständigen Verantwortlichen zugestellt. Zusätzlich wird eine Vorgangsnummer vergeben, damit deine Anfrage eindeutig zuzuordnen ist. Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO (Bearbeitung deiner Anfrage bzw. Anbahnung eines Vertrags) bzw. Art. 6 Abs. 1 lit. f DSGVO für allgemeine Anfragen.</p>
    <p>Für die technische Übermittlung setzen wir zwei Auftragsverarbeiter nach Art. 28 DSGVO ein, mit denen jeweils ein Auftragsverarbeitungsvertrag besteht:</p>
    <ul>
      <li><strong>Cloudflare Germany GmbH</strong> (Rosental 7, 80331 München) nimmt die Formulardaten entgegen. Dabei wird deine IP-Adresse kurzzeitig verarbeitet, um automatisierte Massenanfragen abzuwehren. Weitere Informationen: <a href="https://www.cloudflare.com/de-de/privacypolicy/" class="inline-link" target="_blank" rel="noopener noreferrer">Datenschutzerklärung von Cloudflare</a>.</li>
      <li><strong>Sendinblue GmbH / Brevo</strong> (Köpenicker Straße 126, 10179 Berlin; Konzernsitz Frankreich) versendet die E-Mail an uns. Die Server stehen in der Europäischen Union. Weitere Informationen: <a href="https://www.brevo.com/de/legal/privacypolicy/" class="inline-link" target="_blank" rel="noopener noreferrer">Datenschutzerklärung von Brevo</a>.</li>
    </ul>
    <p>Eine dauerhafte Speicherung deiner Anfrage in einer Datenbank findet nicht statt; die Daten liegen anschließend ausschließlich in unserem E-Mail-Postfach und werden dort gelöscht, sobald deine Anfrage abschließend bearbeitet ist und keine gesetzlichen Aufbewahrungsfristen entgegenstehen.</p>
    <p>Nutzt du zusätzlich freiwillig den WhatsApp-Button, öffnet sich clientseitig WhatsApp mit einer vorausgefüllten Kurznachricht an ${esc(site.contact.phoneDisplay)}. Diese Nachricht sendest du selbst ab; für die Kommunikation über WhatsApp gelten die Datenschutzbestimmungen des Anbieters. Schlägt die direkte Übermittlung fehl, öffnet sich ersatzweise dein eigenes E-Mail-Programm mit vorausgefülltem Text — auch hier entscheidest du selbst über das Absenden.</p>
    ` : `
